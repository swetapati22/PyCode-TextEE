...
def manage_dataset(dataset, key, shots = None, shot_data = None):
    ...
    with open(f"/scratch/spati/tmp/LLaMA/datasets/miniguideline_train100_P_w_NS_{key}_sole_data.json", "w") as f:
        json.dump(dataset_dict, f, indent = 4)
    # Convert to Dataset format
    return Dataset.from_dict(dataset_dict) 

def miniguideline_train100_P_w_NS(shot_data = False):
    ...
    # )
    train_data, valid_data = json.load(open("/scratch/spati/tmp/NLP_Research_Work/TextEE/data/guideline_experiments/ACE_guidelines_w_pos_examples/final_data_split/PA_100_train_w_neg.json")), json.load(open("/scratch/spati/tmp/NLP_Research_Work/TextEE/data/guideline_experiments/ACE_guidelines_w_pos_examples/final_data_split/PA_100_dev_final.json"))
    test_data = json.load(open("/scratch/spati/tmp/NLP_Research_Work/TextEE/data/guideline_experiments/ACE_guidelines_w_pos_examples/final_data_split/PA_100_dev_final.json"))
