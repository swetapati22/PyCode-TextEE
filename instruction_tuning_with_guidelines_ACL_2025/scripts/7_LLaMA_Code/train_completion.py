...
def parse_args():
    ...
    parser.add_argument("--dataset_name", type=str, default="richere_train2000_guidelinePN_Adv_wo_NS", help="Dataset name for training.")
...
def main(args):
    #OLD_wandb_project in swetapati022@gmail.com
    # wandb.init(project = "LLaMAEvents", name = f"LLaMA_3.1-8B_{args.dataset_name}", entity = "isp_gmu")
    # model_name_or_path = "unsloth/Meta-Llama-3.1-8B-bnb-4bit"#parse_model_info(args)
    #new_wandb_project in spati@gmu.edu
    # wandb.init(project = "LLaMAEvents", name = f"LLaMA_3.1-8B_{args.dataset_name}", entity = "isp_gmu-org")
    wandb.init(project="LLaMAEvents", name=f"LLaMA_3.1-8B_{args.dataset_name}", entity="LLaMAEvents")

    model_name_or_path = "unsloth/llama-3-8b-Instruct-bnb-4bit"
    # model_name_or_path = "unsloth/Llama-3.2-11B-Vision-Instruct-bnb-4bit"
    ...
    trainer = LLaMATrainer(
        ...
        args=TrainingArguments(
            ...
            save_strategy = "epoch",
            eval_steps=1, #10 for steps
            save_steps=1, #10 for steps
