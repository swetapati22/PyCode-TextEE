...
@dataclass
class Death(Event):
    def __init__(self, mention: Optional[List] = None, deceased: Optional[List] = None, theme: Optional[List] = None):
        self.mention = mention if mention is not None else []
        self.deceased = deceased if deceased is not None else []
        self.theme = theme if theme is not None else []

    def __repr__(self):
        return f"Death(mention={self.mention}, deceased={self.deceased}, theme={self.theme})"
